...
public class exam04 {
	...
	public static void main(String[] args) {
		 ...
		 * 10<x && x<20 2. char형 변수 ch가 공백이나 탭이 아닐 때 true인 조건식 ch!=" "||ch!=\t
		 * 3. char형 변수 ch가 ‘x' 또는 ’X'일 때 true인 조건식 ch=='x'||ch=='X' 4. char형 변수
		 * ch가 숫자(‘0’~‘9’)일 때 true인 조건식 '0'<= ch && ch <= '9' 5. char형 변수 ch가
...
/*		[4-4] 1+(-2)+3+(-4)+... 과 같은 식으로 계속 더해나갔을 때, 몇까지 더해야 총합이
	...
	*/
	...
	/*for(int x= 1; x<=6; x++){
		for(int y=1; y<=6; y++){
			if((x+y)==6){System.out.println("첫번째 "+x+" 두번째 "+y);
			}
			}
	...
	/*
		...
		*/
		...
		/*[4-15] 다음은 회문수를 구하는 프로그램이다. 회문수(palindrome)란, 숫자를 거꾸로 읽어도 앞으로 
		읽는 것과 같은 수를 말한다. 예를 들면 ‘12321’이나 ‘13531’같은 수를 말한다. 
