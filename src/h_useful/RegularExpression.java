...
public class RegularExpression {
	...
	public static void main(String[] args) {
		 ...
		 * +	앞 문자가 1개 이상
		 * ?	앞 문자가 없거나 1개
		 * []	문자의 집합이나 범위([a-z]: a부터 z까지, [^a-z] :a 부터 z가 아닌것
...
//		String regex = "[a-z]{3}[0-9]{1,3}"; // 패턴표현시 좁게 표현하는게 좋다.
//		String regex = "[a-z0-9]"
//		String regex = "\\w*";
		String regex = 	".*";
...
//		System.out.println(m.matches());
		...
		String id = "pangpang1861";
		String regex1 = "[a-z0-9_-]{5,20}";
		String phonenumber = "010-9600-1861";
		String regex2 = "^0\\d{1,3}-\\d{3,4}-\\d{4}";
		String email = "pangpang1861@naver.com";
